				...
				if(this.settings.ui.theme_name !== false) {
					if(this.settings.ui.theme_path === false) {
						$("script").each(function () { 
							if(this.src.toString().match(/aplosjquery\.tree.*?js.jsf(?:\?.*)?$/)) { _this.settings.ui.theme_path = this.src.toString().replace(/aplosjquery\.tree.*?js.jsf(?:\?.*)?$/, "") + "themes/" + _this.settings.ui.theme_name + "/style.css"; return false; }
						});
					}
