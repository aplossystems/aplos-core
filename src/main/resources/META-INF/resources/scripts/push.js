 ...
 */
AplosComponents.widget.Socket = function (cfg) {
    this.cfg = cfg;
    var $this = this;
    ...
    this.connect = function(uniquePath) {
        if (uniquePath) {
...
AplosComponents.extend(AplosComponents.widget.Socket, AplosComponents.widget.BaseWidget);
