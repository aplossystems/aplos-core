package com.aplos.core.component.fileupload;
...
import com.aplos.core.listeners.MultipartRequest;
...
public class FileUploadRenderer extends CoreRenderer {
	...
	protected void encodeScript(FacesContext context, FileUpload fileUpload) throws IOException {
        ...
        if(!mode.equals("simple")) {
            ...
            if(process != null) {
				writer.write(",process:'" + ComponentUtils.findClientIds(context, fileUpload, process) + "'");
			}
            ...
            if(fileUpload.getFileLimit() != Integer.MAX_VALUE) {
				writer.write(",maxNumberOfFiles:" + fileUpload.getFileLimit());
			}
