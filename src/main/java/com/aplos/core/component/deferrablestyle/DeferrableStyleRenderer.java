...
public class DeferrableStyleRenderer extends Renderer {
		...
		if (resource != null) {
			if( isDeferred ) {
				...
				if( JSFUtil.getRequest().getAttribute(DEFER_STYLE_WRITTEN) == null ) {
					...
					writer.write("i.async=true;i.href=n.url;i.type='text/css';i.rel='stylesheet';i.onerror=function(){if(n.error){n.error()}};i.onload=i.onreadystatechange=function(t,s){" );
