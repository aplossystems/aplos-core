...
public class AjaxBehavior extends ClientBehaviorBase {
    ...
    public final static String BEHAVIOR_ID = "com.aplos.core.component.behavior.ajax.AjaxBehavior";
    ...
    public String getRendererType() {
        return "com.aplos.core.component.behavior.ajax.AjaxBehaviorRenderer";
    }
    ...
    public Integer getRequestDelay() {
        return (Integer) eval("requestDelay", requestDelay);
    }
